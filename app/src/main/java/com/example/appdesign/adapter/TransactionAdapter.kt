...
class TransactionAdapter : ListAdapter<String, TransactionAdapter.TransactionViewHolder>(TransactionDiffCallback()) {
    ...
    class TransactionDiffCallback : DiffUtil.ItemCallback<String>() {
