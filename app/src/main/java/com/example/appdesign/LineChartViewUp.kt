...
class LineChartViewUp(context: Context, attrs: AttributeSet?) : View(context, attrs) {

    private val linePaint = Paint().apply {
        color = resources.getColor(R.color.fffs)
        strokeWidth = 5f
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val gradient = LinearGradient(
            ...
            Color.parseColor("#1A17D921"),
            Color.parseColor("#0017D921"),
